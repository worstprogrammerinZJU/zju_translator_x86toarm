...
.LBB0_1:
	...
	callq	linear_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_2:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	logistic_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_3:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	loggy_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_4:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	relu_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_5:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	elu_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_6:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	selu_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_7:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	relie_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_8:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	ramp_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_9:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	leaky_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_10:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	tanh_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_11:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	plse_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_12:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	stair_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_13:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	hardtan_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_14:
	movss	-8(%rbp), %xmm0                 # xmm0 = mem[0],zero,zero,zero
	callq	lhtan_activate@PLT
	movss	%xmm0, -4(%rbp)
	jmp	.LBB0_16
.LBB0_15:
	xorps	%xmm0, %xmm0
