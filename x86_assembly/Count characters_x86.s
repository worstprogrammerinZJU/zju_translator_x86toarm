...
.L7:
	...
	test	al, al
	jne	.L8
	mov	BYTE PTR -106[rbp], 65
	jmp	.L9
.L11:
	movsx	rdx, BYTE PTR -106[rbp]
	lea	rax, -96[rbp]
	mov	rsi, rdx
	mov	rdi, rax
	call	_ZNSt6vectorIiSaIiEEixEm
...
.L9:
	cmp	BYTE PTR -106[rbp], 90
	jle	.L11
	mov	BYTE PTR -105[rbp], 97
	jmp	.L12
.L14:
	movsx	rdx, BYTE PTR -105[rbp]
	lea	rax, -96[rbp]
	mov	rsi, rdx
	mov	rdi, rax
	call	_ZNSt6vectorIiSaIiEEixEm
...
.LLSDACSB3566:
	.uleb128 .LEHB7-.LFB3566
	.uleb128 .LEHE7-.LEHB7
	.uleb128 .L42-.LFB3566
	.uleb128 0
	.uleb128 .LEHB8-.LFB3566
	.uleb128 .LEHE8-.LEHB8
	.uleb128 0
	.uleb128 0
.LLSDACSE3566:
