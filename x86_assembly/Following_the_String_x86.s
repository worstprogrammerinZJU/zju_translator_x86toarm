...
.L24:
	...
	movsx	rdx, eax
	sub	rdx, 1
	mov	QWORD PTR -608[rbp], rdx
	movsx	rdx, eax
	mov	r14, rdx
	mov	r15d, 0
	movsx	rdx, eax
	mov	QWORD PTR -672[rbp], rdx
	mov	QWORD PTR -664[rbp], 0
	cdqe
	lea	rdx, 0[0+rax*4]
	mov	eax, 16
	sub	rax, 1
...
.L12:
	...
	call	_ZNSirsERi@PLT
.LEHE0:
	add	DWORD PTR -636[rbp], 1
.L11:
	mov	eax, DWORD PTR -640[rbp]
	cmp	DWORD PTR -636[rbp], eax
	jl	.L12
	lea	rax, -560[rbp]
	mov	edx, 520
	mov	esi, 0
	mov	rdi, rax
	call	memset@PLT
	mov	DWORD PTR -632[rbp], 97
	mov	DWORD PTR -628[rbp], 0
	jmp	.L13
.L16:
	mov	rax, QWORD PTR -600[rbp]
	mov	edx, DWORD PTR -628[rbp]
	movsx	rdx, edx
...
.L13:
	mov	eax, DWORD PTR -640[rbp]
	cmp	DWORD PTR -628[rbp], eax
	jl	.L16
	lea	rax, -592[rbp]
	mov	rdi, rax
	call	_ZNSt6vectorIiSaIiEEC1Ev
	mov	DWORD PTR -624[rbp], 0
	jmp	.L17
.L19:
	mov	eax, DWORD PTR -624[rbp]
	cdqe
...
.L18:
	add	DWORD PTR -624[rbp], 1
.L17:
	cmp	DWORD PTR -624[rbp], 129
	jle	.L19
	mov	DWORD PTR -620[rbp], 97
	mov	DWORD PTR -616[rbp], 0
	jmp	.L20
.L23:
	mov	DWORD PTR -612[rbp], 0
	jmp	.L21
.L22:
	mov	eax, DWORD PTR -620[rbp]
	movsx	eax, al
	mov	esi, eax
	lea	rax, _ZSt4cout[rip]
	mov	rdi, rax
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c@PLT
	add	DWORD PTR -612[rbp], 1
.L21:
	mov	eax, DWORD PTR -616[rbp]
	movsx	rdx, eax
	lea	rax, -592[rbp]
	mov	rsi, rdx
	mov	rdi, rax
	...
	cmp	DWORD PTR -612[rbp], eax
	setl	al
	test	al, al
	jne	.L22
	add	DWORD PTR -620[rbp], 1
	add	DWORD PTR -616[rbp], 1
.L20:
	mov	eax, DWORD PTR -616[rbp]
	movsx	rbx, eax
	lea	rax, -592[rbp]
	mov	rdi, rax
	call	_ZSt4sizeISt6vectorIiSaIiEEEDTcldtfp_4sizeEERKT_
	cmp	rbx, rax
	setb	al
	test	al, al
	jne	.L23
