...
.LPSRL0:
	...
	mov	rdi, rax
	call	_ZNSirsERi@PLT
	mov	DWORD PTR -44140[rbp], 0
	jmp	.L2
.L5:
	mov	DWORD PTR -44136[rbp], 0
	jmp	.L3
.L4:
	lea	rcx, -44112[rbp]
	...
	mov	rdi, rax
	call	_ZNSirsERi@PLT
	add	DWORD PTR -44136[rbp], 1
.L3:
	mov	eax, DWORD PTR -44144[rbp]
	cmp	DWORD PTR -44136[rbp], eax
	jl	.L4
	add	DWORD PTR -44140[rbp], 1
.L2:
	mov	eax, DWORD PTR -44144[rbp]
	cmp	DWORD PTR -44140[rbp], eax
	jl	.L5
...
.L9:
	...
	add	rax, rdx
	add	rax, rcx
	mov	eax, DWORD PTR -44112[rbp+rax*4]
	add	DWORD PTR -44128[rbp], eax
...
.L8:
	...
	sub	eax, DWORD PTR -44128[rbp]
	mov	edx, eax
	neg	edx
	cmovns	eax, edx
	mov	DWORD PTR -44116[rbp], eax
