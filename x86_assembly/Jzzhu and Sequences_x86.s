...
.LLSDACSB9735:
	...
	.uleb128 .LEHE4-.LEHB4
	.uleb128 .L114-.LFB9735
	.uleb128 0
	.uleb128 .LEHB5-.LFB9735
	.uleb128 .LEHE5-.LEHB5
	.uleb128 .L115-.LFB9735
	.uleb128 0
...
.LFB10447:
	...
	mov	rdi, rax
.LEHB7:
	call	_ZNSt6vectorIxSaIxEE19_M_range_initializeIPKxEEvT_S5_St20forward_iterator_tag
.LEHE7:
	jmp	.L142
.L141:
	endbr64
...
.LFB10868:
	...
	lea	rax, -8[rbp]
	mov	rdi, rax
	call	_ZSt19__iterator_categoryIPKxENSt15iterator_traitsIT_E17iterator_categoryERKS3_
	mov	rax, QWORD PTR -8[rbp]
	mov	rdx, QWORD PTR -16[rbp]
	mov	rsi, rdx
	mov	rdi, rax
	call	_ZSt10__distanceIPKxENSt15iterator_traitsIT_E15difference_typeES3_S3_St26random_access_iterator_tag
	leave
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.LFB10867:
	...
	mov	rsi, rdx
	mov	rdi, rax
	call	_ZSt8distanceIPKxENSt15iterator_traitsIT_E15difference_typeES3_S3_
	mov	QWORD PTR -24[rbp], rax
	...
	mov	rax, QWORD PTR -48[rbp]
	mov	rdi, rax
	call	_ZSt22__uninitialized_copy_aIPKxPxxET0_T_S4_S3_RSaIT1_E
	mov	rdx, QWORD PTR -40[rbp]
...
.LFB11249:
	...
	mov	rsi, rcx
	mov	rdi, rax
	call	_ZNSt20__uninitialized_copyILb1EE13__uninit_copyIPKxPxEET0_T_S6_S5_
	leave
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.LFB11525:
	...
	mov	rax, QWORD PTR -32[rbp]
	mov	rdi, rax
	call	_ZSt12__niter_baseIPKxET_S2_
	mov	rbx, rax
	mov	rax, QWORD PTR -24[rbp]
	mov	rdi, rax
	call	_ZSt12__niter_baseIPKxET_S2_
