...
.L4:
	cmp	DWORD PTR -124[rbp], 9
	jle	.L5
	add	DWORD PTR -128[rbp], 1
.L3:
	cmp	DWORD PTR -128[rbp], 9
	jle	.L6
...
.L14:
	...
	cmp	al, 88
	jne	.L9
	cmp	DWORD PTR -120[rbp], 3
	jle	.L10
	cmp	DWORD PTR -120[rbp], 5
	jg	.L10
