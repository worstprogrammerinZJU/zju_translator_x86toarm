...
.L6:
	...
	cdqe
	mov	eax, DWORD PTR -428[rbp+rax*4]
	movsx	rdx, eax
	mov	edx, DWORD PTR -416[rbp+rdx*4]
	add	edx, 1
	cdqe
	mov	DWORD PTR -416[rbp+rax*4], edx
	add	DWORD PTR -436[rbp], 1
.L5:
	cmp	DWORD PTR -436[rbp], 2
	jle	.L6
