...
# %bb.0:
	...
	movq	%rsp, %rbp
	subq	$16, %rsp
	movq	.L__const.cttest_optz_more_than_max.args(%rip), %rax
	movq	%rax, -16(%rbp)
	movq	.L__const.cttest_optz_more_than_max.args+8(%rip), %rax
	movq	%rax, -8(%rbp)
	leaq	-16(%rbp), %rsi
	leaq	srv(%rip), %rdi
	callq	optparse@PLT
	cmpl	$1073741824, job_data_size_limit(%rip) # imm = 0x40000000
	sete	%al
	andb	$1, %al
	movzbl	%al, %edi
	callq	assert@PLT
