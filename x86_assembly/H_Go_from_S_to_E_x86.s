...
_Z3solii:
	...
	mov	eax, DWORD PTR Ex[rip]
	cmp	DWORD PTR -52[rbp], eax
	jne	.L51
	mov	eax, DWORD PTR Ey[rip]
...
main:
	...
	je	.L60
	mov	eax, DWORD PTR -4[rbp]
	mov	DWORD PTR Sx[rip], eax
	mov	eax, DWORD PTR -8[rbp]
	mov	DWORD PTR Sy[rip], eax
	mov	eax, DWORD PTR -4[rbp]
	cdqe
	mov	rsi, rax
	lea	rax, arr[rip]
	...
	je	.L61
	mov	eax, DWORD PTR -4[rbp]
	mov	DWORD PTR Ex[rip], eax
	mov	eax, DWORD PTR -8[rbp]
	mov	DWORD PTR Ey[rip], eax
	...
	jl	.L63
	mov	edx, DWORD PTR Sy[rip]
	mov	eax, DWORD PTR Sx[rip]
	mov	esi, edx
	mov	edi, eax
	call	_Z3solii
	test	al, al
