...
.L19:
	...
	mov	DWORD PTR -20096[rbp], 0
	jmp	.L11
.L12:
	lea	rdx, -20032[rbp]
	mov	eax, DWORD PTR -20096[rbp]
	cdqe
	sal	rax, 2
	add	rax, rdx
	mov	rsi, rax
...
.LEHB0:
	...
	add	DWORD PTR -20096[rbp], 1
.L11:
	mov	eax, DWORD PTR -20100[rbp]
	cmp	DWORD PTR -20096[rbp], eax
	jl	.L12
	lea	rax, -20080[rbp]
	mov	rdi, rax
...
.L13:
	...
	mov	BYTE PTR -20101[rbp], 0
	mov	DWORD PTR -20096[rbp], 0
	jmp	.L15
.L18:
	mov	eax, DWORD PTR -20096[rbp]
	cdqe
	mov	eax, DWORD PTR -20032[rbp+rax*4]
	mov	DWORD PTR -20092[rbp], eax
	mov	eax, DWORD PTR -20092[rbp]
	sub	eax, 1
	cdqe
	mov	eax, DWORD PTR -20032[rbp+rax*4]
	mov	DWORD PTR -20088[rbp], eax
	mov	eax, DWORD PTR -20088[rbp]
	sub	eax, 1
	cdqe
	mov	eax, DWORD PTR -20032[rbp+rax*4]
	mov	DWORD PTR -20084[rbp], eax
	mov	eax, DWORD PTR -20092[rbp]
	cmp	eax, DWORD PTR -20088[rbp]
	je	.L16
	mov	eax, DWORD PTR -20088[rbp]
	cmp	eax, DWORD PTR -20084[rbp]
	je	.L16
	mov	eax, DWORD PTR -20084[rbp]
	cmp	eax, DWORD PTR -20092[rbp]
	je	.L16
	mov	eax, DWORD PTR -20084[rbp]
	sub	eax, 1
	cdqe
	mov	eax, DWORD PTR -20032[rbp+rax*4]
	cmp	DWORD PTR -20092[rbp], eax
	jne	.L16
	mov	BYTE PTR -20101[rbp], 1
	lea	rax, .LC2[rip]
	mov	rdi, rax
	call	puts@PLT
	jmp	.L17
