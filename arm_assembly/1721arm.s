...
// %bb.0:
	...
	bl	LUA_IMPORT_INT
	ldr	x0, [sp, #24]
	adrp	x8, affected_rows
	ldr	w1, [x8, :lo12:affected_rows]
	bl	LUA_IMPORT_INT
	mov	x0, xzr
	bl	g_string_new
	stur	x0, [x29, #-16]
	...
	ret
.Lfunc_end0:
	.size	lua_proto_append_ok_packet, .Lfunc_end0-lua_proto_append_ok_packet
                                        // -- End function
...
server_status:
	...
	.type	insert_id,@object               // @insert_id
	.globl	insert_id
	.p2align	2
insert_id:
	.word	0                               // 0x0
...
warnings:
	.word	0                               // 0x0
	.size	warnings, 4
	.type	affected_rows,@object           // @affected_rows
	.globl	affected_rows
	.p2align	2
affected_rows:
	.word	0                               // 0x0
