	.text
	.globl	decNumberNextPlus               // -- Begin function decNumberNextPlus
	.p2align	2
	.type	decNumberNextPlus,@function
decNumberNextPlus:                      // @decNumberNextPlus
// %bb.0:
	sub	sp, sp, #96
	...
	ldr	w8, [x8]
	adrp	x9, DECINF
	ldr	w11, [x9, :lo12:DECINF]
	adrp	x10, DECNEG
	ldr	w12, [x10, :lo12:DECNEG]
	orr	w11, w11, w12
	and	w8, w8, w11
...
.LBB0_2:
	...
	subs	x8, x8, #1
	str	x8, [sp, #40]
	adrp	x8, DEC_ROUND_CEILING
	ldr	w8, [x8, :lo12:DEC_ROUND_CEILING]
	add	x3, sp, #20
	str	w8, [sp, #20]
	ldur	x0, [x29, #-16]
	ldur	x1, [x29, #-24]
...
.LBB0_5:
	...
	ret
.Lfunc_end0:
	.size	decNumberNextPlus, .Lfunc_end0-decNumberNextPlus
                                        // -- End function
...
DEC_MIN_EMIN:
	.xword	0                               // 0x0
	.size	DEC_MIN_EMIN, 8
	.type	DEC_ROUND_CEILING,@object       // @DEC_ROUND_CEILING
	.globl	DEC_ROUND_CEILING
	.p2align	2
DEC_ROUND_CEILING:
	.word	0                               // 0x0
	.size	DEC_ROUND_CEILING, 4
