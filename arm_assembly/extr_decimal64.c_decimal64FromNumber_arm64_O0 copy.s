	...
	.p2align	2
	.type	decimal64FromNumber,@function
...
// %bb.0:
	...
	ldur	x8, [x29, #-16]
	ldr	w8, [x8, #8]
	adrp	x9, DECIMAL64_Pmax
	ldr	w9, [x9, :lo12:DECIMAL64_Pmax]
	subs	w8, w8, w9
	b.gt	.LBB0_3
	b	.LBB0_1
.LBB0_1:
	ldur	x8, [x29, #-40]
	adrp	x9, DECIMAL64_Emax
	ldr	x9, [x9, :lo12:DECIMAL64_Emax]
	subs	x8, x8, x9
	b.gt	.LBB0_3
	b	.LBB0_2
.LBB0_2:
	ldur	x8, [x29, #-40]
	adrp	x9, DECIMAL64_Emin
	ldr	x9, [x9, :lo12:DECIMAL64_Emin]
	subs	x8, x8, x9
	b.ge	.LBB0_4
	b	.LBB0_3
.LBB0_3:
...
.LBB0_17:
	...
	ldr	x10, [x9, :lo12:DECIMAL64_Bias]
	mov	x9, xzr
	subs	x9, x9, x10
	subs	x8, x8, x9
	b.ge	.LBB0_19
...
.LBB0_19:
	...
	stur	w8, [x29, #-80]
	ldur	w8, [x29, #-80]
	adrp	x9, DECIMAL64_Ehigh
	ldr	w9, [x9, :lo12:DECIMAL64_Ehigh]
	subs	w8, w8, w9
	b.le	.LBB0_21
	b	.LBB0_20
.LBB0_20:
	adrp	x8, DECIMAL64_Ehigh
	ldr	w8, [x8, :lo12:DECIMAL64_Ehigh]
	stur	w8, [x29, #-80]
	adrp	x8, DEC_Clamped
	ldr	w9, [x8, :lo12:DEC_Clamped]
	ldur	w8, [x29, #-28]
...
.LBB0_24:
	ldur	w9, [x29, #-80]
	adrp	x8, DECIMAL64_Ehigh
	ldr	w10, [x8, :lo12:DECIMAL64_Ehigh]
	subs	w10, w9, w10
                                        // implicit-def: $x9
	mov	w9, w10
	sxtw	x9, w9
...
.LBB0_47:
	...
	ret
.Lfunc_end0:
	.size	decimal64FromNumber, .Lfunc_end0-decimal64FromNumber
                                        // -- End function
	.type	DECIMAL64_Pmax,@object          // @DECIMAL64_Pmax
	.bss
	.globl	DECIMAL64_Pmax
	.p2align	2
DECIMAL64_Pmax:
	.word	0                               // 0x0
	.size	DECIMAL64_Pmax, 4
	.type	DECIMAL64_Emax,@object          // @DECIMAL64_Emax
	.globl	DECIMAL64_Emax
	.p2align	3
DECIMAL64_Emax:
	.xword	0                               // 0x0
	.size	DECIMAL64_Emax, 8
	.type	DECIMAL64_Emin,@object          // @DECIMAL64_Emin
	.globl	DECIMAL64_Emin
	.p2align	3
DECIMAL64_Emin:
	.xword	0                               // 0x0
	.size	DECIMAL64_Emin, 8
...
DEC_Clamped:
	.word	0                               // 0x0
	.size	DEC_Clamped, 4
	.type	DECIMAL64_Ehigh,@object         // @DECIMAL64_Ehigh
	.globl	DECIMAL64_Ehigh
	.p2align	2
DECIMAL64_Ehigh:
	.word	0                               // 0x0
	.size	DECIMAL64_Ehigh, 4
