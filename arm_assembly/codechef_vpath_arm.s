...
.LFB9716:
	...
	ldr	x0, [sp, 40]
	mov	x1, x0
	adrp	x0, solutionArray
	add	x0, x0, :lo12:solutionArray
	bl	_ZNSt6vectorIxSaIxEEixEm
	str	x19, [x0]
	str	xzr, [sp, 88]
	str	xzr, [sp, 80]
...
.L25:
	...
	adrp	x0, v
	add	x0, x0, :lo12:v
	bl	_ZNSt6vectorIS_IxSaIxEESaIS1_EE6resizeEm
	ldr	x0, [sp, 32]
	add	x0, x0, 1
	mov	x1, x0
	adrp	x0, solutionArray
...
.L23:
	...
	adrp	x0, v
	add	x0, x0, :lo12:v
	bl	_ZNSt6vectorIS_IxSaIxEESaIS1_EE5clearEv
	adrp	x0, totalVal
	add	x0, x0, :lo12:totalVal
	bl	_ZNSt6vectorIxSaIxEE5clearEv
.L22:
...
.LFB10428:
	...
	mov	x1, x0
	ldr	x0, [sp, 24]
	bl	_ZNSt6vectorIS_IxSaIxEESaIS1_EE17_M_default_appendEm
	b	.L45
.L43:
	ldr	x0, [sp, 24]
	bl	_ZNKSt6vectorIS_IxSaIxEESaIS1_EE4sizeEv
...
.LEHE1:
	...
	mov	x1, x20
	mov	x0, x19
	bl	_ZNSt6vectorIS_IxSaIxEESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_
	ldr	x3, [sp, 40]
	ldr	x0, [sp, 40]
	ldr	x4, [x0]
	ldr	x0, [sp, 40]
...
.LLSDACSB10854:
	.uleb128 .LEHB5-.LFB10854
	.uleb128 .LEHE5-.LEHB5
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB6-.LFB10854
	.uleb128 .LEHE6-.LEHB6
	.uleb128 .L94-.LFB10854
	.uleb128 0x1
	.uleb128 .LEHB7-.LFB10854
	.uleb128 .LEHE7-.LEHB7
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB8-.LFB10854
	.uleb128 .LEHE8-.LEHB8
	.uleb128 .L95-.LFB10854
	.uleb128 0
...
.LFB11072:
	...
	ldr	x1, [sp, 32]
	ldr	x0, [sp, 40]
	bl	_ZNSt6vectorIS_IxSaIxEESaIS1_EE14_S_do_relocateEPS1_S4_S4_RS2_St17integral_constantIbLb1EE
	ldp	x29, x30, [sp], 48
	.cfi_restore 30
	.cfi_restore 29
	.cfi_def_cfa_offset 0
...
.LFB11233:
	...
	ldr	x1, [sp, 48]
	ldr	x0, [sp, 56]
	bl	_ZSt12__relocate_aIPSt6vectorIxSaIxEES3_SaIS2_EET0_T_S6_S5_RT1_
	ldp	x29, x30, [sp], 64
	.cfi_restore 30
	.cfi_restore 29
	.cfi_def_cfa_offset 0
...
.LFB11330:
	...
	mov	x1, x20
	mov	x0, x19
	bl	_ZSt14__relocate_a_1IPSt6vectorIxSaIxEES3_SaIS2_EET0_T_S6_S5_RT1_
	ldp	x19, x20, [sp, 16]
	ldp	x29, x30, [sp], 64
	.cfi_restore 30
	.cfi_restore 29
...
.L224:
	...
	mov	x1, x0
	mov	x0, x19
	bl	_ZSt19__relocate_object_aISt6vectorIxSaIxEES2_SaIS2_EEvPT_PT0_RT1_
	ldr	x0, [sp, 56]
	add	x0, x0, 24
	str	x0, [sp, 56]
	ldr	x0, [sp, 72]
...
.LFB11522:
	...
	ldr	x1, [sp, 40]
	ldr	x0, [sp, 24]
	bl	_ZNSt16allocator_traitsISaISt6vectorIxSaIxEEEE9constructIS2_JS2_EEEvRS3_PT_DpOT0_
	ldr	x0, [sp, 32]
	bl	_ZSt11__addressofISt6vectorIxSaIxEEEPT_RS3_
	mov	x1, x0
	ldr	x0, [sp, 24]
...
.LFB11558:
	...
	ldr	x1, [sp, 32]
	ldr	x0, [sp, 40]
	bl	_ZN9__gnu_cxx13new_allocatorISt6vectorIxSaIxEEE9constructIS3_JS3_EEEvPT_DpOT0_
	nop
	ldp	x29, x30, [sp], 48
	.cfi_restore 30
	.cfi_restore 29
