...
.LFB9698:
	...
	mov	x2, x1
	mov	x1, 0
	bl	_ZNSt24uniform_int_distributionIxEC1Exx
	add	x2, sp, 32
	adrp	x0, rang
	add	x1, x0, :lo12:rang
	mov	x0, x2
	bl	_ZNSt24uniform_int_distributionIxEclISt23mersenne_twister_engineImLm64ELm312ELm156ELm31ELm13043109905998158313ELm29ELm6148914691236517205ELm17ELm8202884508482404352ELm37ELm18444473444759240704ELm43ELm6364136223846793005EEEExRT_
	ldp	x29, x30, [sp], 48
	.cfi_restore 30
	.cfi_restore 29
	.cfi_def_cfa_offset 0
	...
	.cfi_endproc
.LFE9698:
	.size	_Z3rngx, .-_Z3rngx
	.global	isPrime
	.bss
	.align	3
	.type	isPrime, %object
	.size	isPrime, 1000001
isPrime:
	.zero	1000001
	.text
	.align	2
...
.LFB10395:
	...
	ldr	x2, [sp, 24]
	ldr	x1, [sp, 32]
	bl	_ZNSt24uniform_int_distributionIxE10param_typeC1Exx
	nop
	ldp	x29, x30, [sp], 48
	.cfi_restore 30
	.cfi_restore 29
...
.LFB10397:
	...
	ldr	x1, [sp, 16]
	ldr	x0, [sp, 24]
	bl	_ZNSt24uniform_int_distributionIxEclISt23mersenne_twister_engineImLm64ELm312ELm156ELm31ELm13043109905998158313ELm29ELm6148914691236517205ELm17ELm8202884508482404352ELm37ELm18444473444759240704ELm43ELm6364136223846793005EEEExRT_RKNS0_10param_typeE
	ldp	x29, x30, [sp], 32
	.cfi_restore 30
	.cfi_restore 29
	.cfi_def_cfa_offset 0
...
.LFB10810:
	...
	str	x0, [sp, 112]
	ldr	x0, [sp, 40]
	bl	_ZNKSt24uniform_int_distributionIxE10param_type1bEv
	mov	x19, x0
	ldr	x0, [sp, 40]
	bl	_ZNKSt24uniform_int_distributionIxE10param_type1aEv
	sub	x0, x19, x0
	str	x0, [sp, 104]
	ldr	x0, [sp, 104]
	cmn	x0, #1
	...
	ldr	x1, [sp, 88]
	ldr	x0, [sp, 48]
	bl	_ZNSt24uniform_int_distributionIxE5_S_ndIoSt23mersenne_twister_engineImLm64ELm312ELm156ELm31ELm13043109905998158313ELm29ELm6148914691236517205ELm17ELm8202884508482404352ELm37ELm18444473444759240704ELm43ELm6364136223846793005EEmEET1_RT0_S4_
	str	x0, [sp, 128]
	b	.L66
.L65:
	ldr	x0, [sp, 48]
...
.LFE11548:
	...
	.align	2
	.type	_GLOBAL__sub_I_rang, %function
_GLOBAL__sub_I_rang:
.LFB11571:
	.cfi_startproc
	stp	x29, x30, [sp, -16]!
	...
	.cfi_endproc
.LFE11571:
	.size	_GLOBAL__sub_I_rang, .-_GLOBAL__sub_I_rang
	.section	.init_array,"aw",%init_array
	.align	3
	.xword	_GLOBAL__sub_I_rang
