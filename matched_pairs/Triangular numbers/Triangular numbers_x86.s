...
.LEHE0:
	...
	mov	DWORD PTR -164[rbp], 6
	mov	DWORD PTR -160[rbp], 10
	mov	DWORD PTR -156[rbp], 15
	mov	DWORD PTR -152[rbp], 21
	mov	DWORD PTR -148[rbp], 28
	mov	DWORD PTR -144[rbp], 36
	mov	DWORD PTR -140[rbp], 45
	mov	DWORD PTR -136[rbp], 55
	mov	DWORD PTR -132[rbp], 66
	mov	DWORD PTR -128[rbp], 78
	mov	DWORD PTR -124[rbp], 91
	mov	DWORD PTR -120[rbp], 105
	mov	DWORD PTR -116[rbp], 120
	mov	DWORD PTR -112[rbp], 136
	mov	DWORD PTR -108[rbp], 153
	mov	DWORD PTR -104[rbp], 171
	mov	DWORD PTR -100[rbp], 190
	mov	DWORD PTR -96[rbp], 210
	mov	DWORD PTR -92[rbp], 231
	mov	DWORD PTR -88[rbp], 253
	mov	DWORD PTR -84[rbp], 276
	mov	DWORD PTR -80[rbp], 300
	mov	DWORD PTR -76[rbp], 325
	mov	DWORD PTR -72[rbp], 351
	mov	DWORD PTR -68[rbp], 378
	mov	DWORD PTR -64[rbp], 406
	mov	DWORD PTR -60[rbp], 435
	mov	DWORD PTR -56[rbp], 465
	mov	DWORD PTR -52[rbp], 496
	lea	rax, -176[rbp]
	mov	r12, rax
	mov	r13d, 32
	lea	rax, -224[rbp]
