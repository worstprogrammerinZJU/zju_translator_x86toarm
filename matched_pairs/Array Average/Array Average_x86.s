...
res:
	.zero	8
	.text
	.globl	_Z3soldRSt6vectorIdSaIdEE
	.type	_Z3soldRSt6vectorIdSaIdEE, @function
_Z3soldRSt6vectorIdSaIdEE:
.LFB9735:
	.cfi_startproc
	endbr64
	push	rbp
	...
	movsd	xmm0, QWORD PTR cnt[rip]
	ucomisd	xmm0, QWORD PTR -8[rbp]
	jp	.L128
	ucomisd	xmm0, QWORD PTR -8[rbp]
	jne	.L128
	mov	rax, QWORD PTR res[rip]
	jmp	.L130
.L128:
	movsd	xmm0, QWORD PTR cnt[rip]
...
.L132:
	...
	movsd	xmm0, QWORD PTR res[rip]
	addsd	xmm0, xmm1
	movsd	QWORD PTR res[rip], xmm0
	movsd	xmm1, QWORD PTR cnt[rip]
	movsd	xmm0, QWORD PTR .LC1[rip]
	addsd	xmm0, xmm1
	movsd	QWORD PTR cnt[rip], xmm0
	mov	rdx, QWORD PTR -16[rbp]
	mov	rax, QWORD PTR -8[rbp]
	mov	rdi, rdx
	movq	xmm0, rax
	call	_Z3soldRSt6vectorIdSaIdEE
	movq	rax, xmm0
	nop
.L130:
	movq	xmm0, rax
	...
	.cfi_endproc
.LFE9735:
	.size	_Z3soldRSt6vectorIdSaIdEE, .-_Z3soldRSt6vectorIdSaIdEE
	.globl	main
	.type	main, @function
main:
.LFB9736:
...
.LLSDACSB9736:
	...
	.uleb128 .LEHE4-.LEHB4
	.uleb128 .L143-.LFB9736
	.uleb128 0
	.uleb128 .LEHB5-.LFB9736
	.uleb128 .LEHE5-.LEHB5
	.uleb128 .L144-.LFB9736
	.uleb128 0
...
.LLSDACSB10452:
	.uleb128 .LEHB7-.LFB10452
	.uleb128 .LEHE7-.LEHB7
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB8-.LFB10452
	.uleb128 .LEHE8-.LEHB8
	.uleb128 .L172-.LFB10452
	.uleb128 0
	.uleb128 .LEHB9-.LFB10452
	.uleb128 .LEHE9-.LEHB9
	.uleb128 0
	.uleb128 0
.LLSDACSE10452:
...
.LLSDACSB10879:
	...
	.uleb128 .L204-.LFB10879
	.uleb128 0
	.uleb128 .LEHB11-.LFB10879
