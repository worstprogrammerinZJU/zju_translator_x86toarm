...
.L18:
	...
	mov	rsi, rdx
	mov	rdi, rax
	call	_ZSt7reverseISt15_Deque_iteratorIiRiPiEEvT_S4_
.LEHE1:
.L20:
	lea	rax, -64[rbp]
	mov	rdi, rax
...
.LFB10422:
	...
	mov	rdi, rax
	call	_ZSt19__iterator_categoryISt15_Deque_iteratorIiRiPiEENSt15iterator_traitsIT_E17iterator_categoryERKS5_
	...
	mov	rsi, rdx
	mov	rdi, rax
	call	_ZSt9__reverseISt15_Deque_iteratorIiRiPiEEvT_S4_St26random_access_iterator_tag
	nop
	mov	rax, QWORD PTR -8[rbp]
	sub	rax, QWORD PTR fs:40
	je	.L70
...
.LLSDACSB10820:
	.uleb128 .LEHB5-.LFB10820
	.uleb128 .LEHE5-.LEHB5
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB6-.LFB10820
	.uleb128 .LEHE6-.LEHB6
	.uleb128 .L77-.LFB10820
	.uleb128 0x1
	.uleb128 .LEHB7-.LFB10820
	.uleb128 .LEHE7-.LEHB7
	.uleb128 .L78-.LFB10820
	.uleb128 0
...
.L111:
	...
	mov	rsi, rdx
	mov	rdi, rax
	call	_ZSt9iter_swapISt15_Deque_iteratorIiRiPiES3_EvT_T0_
	mov	rax, QWORD PTR -88[rbp]
	mov	rdi, rax
...
.L110:
	...
	mov	rsi, rdx
	mov	rdi, rax
	call	_ZStltRKSt15_Deque_iteratorIiRiPiES4_
	test	al, al
	jne	.L111
	jmp	.L107
.L113:
...
.LLSDACSB11045:
	.uleb128 .LEHB9-.LFB11045
	.uleb128 .LEHE9-.LEHB9
	.uleb128 .L121-.LFB11045
	.uleb128 0
	.uleb128 .LEHB10-.LFB11045
...
.LLSDACSB11046:
	.uleb128 .LEHB11-.LFB11046
	.uleb128 .LEHE11-.LEHB11
	.uleb128 .L128-.LFB11046
	.uleb128 0x1
	.uleb128 .LEHB12-.LFB11046
	.uleb128 .LEHE12-.LEHB12
	.uleb128 .L129-.LFB11046
	.uleb128 0
	.uleb128 .LEHB13-.LFB11046
