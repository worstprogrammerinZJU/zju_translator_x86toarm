...
.LEHB1:
	...
	add	x1, sp, 68
	add	x0, sp, 72
	bl	_ZNSt5dequeIiSaIiEE10push_frontERKi
.L14:
	add	x2, sp, 32
	adrp	x0, .LC5
	add	x1, x0, :lo12:.LC5
...
.L16:
	...
	beq	.L19
	add	x0, sp, 72
	bl	_ZNSt5dequeIiSaIiEE5frontEv
	ldr	w0, [x0]
	mov	w1, w0
	adrp	x0, :got:_ZSt4cout
	ldr	x0, [x0, #:got_lo12:_ZSt4cout]
	...
	bl	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c
	add	x0, sp, 72
	bl	_ZNSt5dequeIiSaIiEE9pop_frontEv
	b	.L18
.L19:
	adrp	x0, .LC7
	add	x1, x0, :lo12:.LC7
...
.L18:
	...
	add	x1, sp, 192
	add	x0, sp, 160
	bl	_ZSt7reverseISt15_Deque_iteratorIiRiPiEEvT_S4_
.LEHE1:
.L20:
	add	x0, sp, 32
...
.L40:
	ldr	x1, [sp, 16]
	ldr	x0, [sp, 24]
	bl	_ZNSt5dequeIiSaIiEE17_M_push_front_auxIJRKiEEEvDpOT_
.L42:
	nop
	ldp	x29, x30, [sp], 32
	.cfi_restore 30
...
.L58:
	ldr	x0, [sp, 24]
	bl	_ZNSt5dequeIiSaIiEE16_M_pop_front_auxEv
.L60:
	nop
	ldp	x29, x30, [sp], 32
	.cfi_restore 30
...
.LFE10413:
	...
	.section	.text._ZSt7reverseISt15_Deque_iteratorIiRiPiEEvT_S4_,"axG",@progbits,_ZSt7reverseISt15_Deque_iteratorIiRiPiEEvT_S4_,comdat
	.align	2
	.weak	_ZSt7reverseISt15_Deque_iteratorIiRiPiEEvT_S4_
	.type	_ZSt7reverseISt15_Deque_iteratorIiRiPiEEvT_S4_, %function
_ZSt7reverseISt15_Deque_iteratorIiRiPiEEvT_S4_:
.LFB10414:
	.cfi_startproc
	stp	x29, x30, [sp, -112]!
	...
	add	x0, sp, 48
	mov	w2, w19
	bl	_ZSt9__reverseISt15_Deque_iteratorIiRiPiEEvT_S4_St26random_access_iterator_tag
	nop
	ldr	x19, [sp, 16]
	ldp	x29, x30, [sp], 112
	.cfi_restore 30
	...
	.cfi_endproc
.LFE10414:
	.size	_ZSt7reverseISt15_Deque_iteratorIiRiPiEEvT_S4_, .-_ZSt7reverseISt15_Deque_iteratorIiRiPiEEvT_S4_
...
.LLSDACSB10812:
	...
	.uleb128 .LEHE6-.LEHB6
	.uleb128 .L71-.LFB10812
	.uleb128 0x1
	.uleb128 .LEHB7-.LFB10812
	.uleb128 .LEHE7-.LEHB7
	.uleb128 .L72-.LFB10812
	.uleb128 0
...
.L83:
	mov	x1, 1
	ldr	x0, [sp, 40]
	bl	_ZNSt5dequeIiSaIiEE23_M_reserve_map_at_frontEm
	ldr	x1, [sp, 40]
	ldr	x0, [sp, 40]
	ldr	x0, [x0, 40]
	sub	x19, x0, #8
...
.LFE10830:
	...
	.section	.text._ZSt9__reverseISt15_Deque_iteratorIiRiPiEEvT_S4_St26random_access_iterator_tag,"axG",@progbits,_ZSt9__reverseISt15_Deque_iteratorIiRiPiEEvT_S4_St26random_access_iterator_tag,comdat
	.align	2
	.weak	_ZSt9__reverseISt15_Deque_iteratorIiRiPiEEvT_S4_St26random_access_iterator_tag
	.type	_ZSt9__reverseISt15_Deque_iteratorIiRiPiEEvT_S4_St26random_access_iterator_tag, %function
_ZSt9__reverseISt15_Deque_iteratorIiRiPiEEvT_S4_St26random_access_iterator_tag:
.LFB10831:
	.cfi_startproc
	stp	x29, x30, [sp, -112]!
	.cfi_def_cfa_offset 112
...
.L103:
	...
	add	x1, sp, 80
	add	x0, sp, 48
	bl	_ZSt9iter_swapISt15_Deque_iteratorIiRiPiES3_EvT_T0_
	ldr	x0, [sp, 40]
	bl	_ZNSt15_Deque_iteratorIiRiPiEppEv
	ldr	x0, [sp, 32]
	bl	_ZNSt15_Deque_iteratorIiRiPiEmmEv
.L102:
	ldr	x1, [sp, 32]
	ldr	x0, [sp, 40]
	bl	_ZStltRKSt15_Deque_iteratorIiRiPiES4_
	and	w0, w0, 255
	cmp	w0, 0
	bne	.L103
	b	.L99
...
.L99:
	...
	.cfi_endproc
.LFE10831:
	.size	_ZSt9__reverseISt15_Deque_iteratorIiRiPiEEvT_S4_St26random_access_iterator_tag, .-_ZSt9__reverseISt15_Deque_iteratorIiRiPiEEvT_S4_St26random_access_iterator_tag
...
.LLSDACSB11037:
	.uleb128 .LEHB9-.LFB11037
	.uleb128 .LEHE9-.LEHB9
	.uleb128 .L111-.LFB11037
	.uleb128 0
	.uleb128 .LEHB10-.LFB11037
...
.LLSDA11038:
	.byte	0xff
	.byte	0x9b
	.uleb128 .LLSDATT11038-.LLSDATTD11038
.LLSDATTD11038:
	.byte	0x1
	.uleb128 .LLSDACSE11038-.LLSDACSB11038
.LLSDACSB11038:
	.uleb128 .LEHB11-.LFB11038
	.uleb128 .LEHE11-.LEHB11
	.uleb128 .L118-.LFB11038
	.uleb128 0x1
	.uleb128 .LEHB12-.LFB11038
	.uleb128 .LEHE12-.LEHB12
	.uleb128 .L119-.LFB11038
	.uleb128 0
	.uleb128 .LEHB13-.LFB11038
...
_ZNSt15_Deque_iteratorIiRiPiEppEv:
.LFB11053:
	.cfi_startproc
	stp	x29, x30, [sp, -32]!
	.cfi_def_cfa_offset 32
...
.L140:
	...
	.cfi_endproc
.LFE11053:
	.size	_ZNSt15_Deque_iteratorIiRiPiEppEv, .-_ZNSt15_Deque_iteratorIiRiPiEppEv
...
.LFE11055:
	...
	.section	.text._ZStltRKSt15_Deque_iteratorIiRiPiES4_,"axG",@progbits,_ZStltRKSt15_Deque_iteratorIiRiPiES4_,comdat
	.align	2
	.weak	_ZStltRKSt15_Deque_iteratorIiRiPiES4_
	.type	_ZStltRKSt15_Deque_iteratorIiRiPiES4_, %function
_ZStltRKSt15_Deque_iteratorIiRiPiES4_:
.LFB11057:
	.cfi_startproc
	sub	sp, sp, #16
	.cfi_def_cfa_offset 16
...
.L148:
	...
	.cfi_endproc
.LFE11057:
	.size	_ZStltRKSt15_Deque_iteratorIiRiPiES4_, .-_ZStltRKSt15_Deque_iteratorIiRiPiES4_
	.section	.text._ZSt9iter_swapISt15_Deque_iteratorIiRiPiES3_EvT_T0_,"axG",@progbits,_ZSt9iter_swapISt15_Deque_iteratorIiRiPiES3_EvT_T0_,comdat
	.align	2
	.weak	_ZSt9iter_swapISt15_Deque_iteratorIiRiPiES3_EvT_T0_
	.type	_ZSt9iter_swapISt15_Deque_iteratorIiRiPiES3_EvT_T0_, %function
_ZSt9iter_swapISt15_Deque_iteratorIiRiPiES3_EvT_T0_:
.LFB11058:
	.cfi_startproc
	stp	x29, x30, [sp, -48]!
	.cfi_def_cfa_offset 48
	...
	.cfi_endproc
.LFE11058:
	.size	_ZSt9iter_swapISt15_Deque_iteratorIiRiPiES3_EvT_T0_, .-_ZSt9iter_swapISt15_Deque_iteratorIiRiPiES3_EvT_T0_
