...
main:
	...
	mov	BYTE PTR -144[rbp], 81
	mov	DWORD PTR -140[rbp], 9
	mov	BYTE PTR -136[rbp], 113
	mov	DWORD PTR -132[rbp], 9
	mov	BYTE PTR -128[rbp], 82
	mov	DWORD PTR -124[rbp], 5
	mov	BYTE PTR -120[rbp], 114
	mov	DWORD PTR -116[rbp], 5
	mov	BYTE PTR -112[rbp], 66
	mov	DWORD PTR -108[rbp], 3
	mov	BYTE PTR -104[rbp], 98
	mov	DWORD PTR -100[rbp], 3
	mov	BYTE PTR -96[rbp], 78
	mov	DWORD PTR -92[rbp], 3
	mov	BYTE PTR -88[rbp], 110
	mov	DWORD PTR -84[rbp], 3
	mov	BYTE PTR -80[rbp], 80
	mov	DWORD PTR -76[rbp], 1
	mov	BYTE PTR -72[rbp], 112
