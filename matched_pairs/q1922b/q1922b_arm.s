...
_ZNSt8__detailL19_S_invalid_state_idE:
	...
	.text
	.align	2
	.global	_Z12calculateNCrxx
	.type	_Z12calculateNCrxx, %function
_Z12calculateNCrxx:
.LFB9696:
	.cfi_startproc
	sub	sp, sp, #32
...
.L9:
	...
	.cfi_endproc
.LFE9696:
	.size	_Z12calculateNCrxx, .-_Z12calculateNCrxx
...
.LFE9706:
	...
	.text
	.align	2
	.global	_Z10Partition3RSt6vectorIxSaIxEExx
	.type	_Z10Partition3RSt6vectorIxSaIxEExx, %function
_Z10Partition3RSt6vectorIxSaIxEExx:
.LFB9697:
	.cfi_startproc
...
.LLSDACSE9697:
	.text
	.size	_Z10Partition3RSt6vectorIxSaIxEExx, .-_Z10Partition3RSt6vectorIxSaIxEExx
	.align	2
	.global	_Z10QuickSort3RSt6vectorIxSaIxEExx
	.type	_Z10QuickSort3RSt6vectorIxSaIxEExx, %function
_Z10QuickSort3RSt6vectorIxSaIxEExx:
.LFB9714:
	.cfi_startproc
	.cfi_personality 0x9b,DW.ref.__gxx_personality_v0
...
.L29:
	...
	ldr	x0, [sp, 56]
.LEHB2:
	bl	_Z10Partition3RSt6vectorIxSaIxEExx
.LEHE2:
	add	x0, sp, 72
	mov	x1, 0
	bl	_ZNSt6vectorIxSaIxEEixEm
	...
	ldr	x0, [sp, 56]
.LEHB3:
	bl	_Z10QuickSort3RSt6vectorIxSaIxEExx
	add	x0, sp, 72
	mov	x1, 1
	bl	_ZNSt6vectorIxSaIxEEixEm
	ldr	x0, [x0]
...
.LLSDACSE9714:
	.text
	.size	_Z10QuickSort3RSt6vectorIxSaIxEExx, .-_Z10QuickSort3RSt6vectorIxSaIxEExx
	.align	2
	.global	main
	.type	main, %function
main:
...
.LFE11559:
	...
	.align	2
	.type	_GLOBAL__sub_I__Z12calculateNCrxx, %function
_GLOBAL__sub_I__Z12calculateNCrxx:
.LFB11582:
	.cfi_startproc
	stp	x29, x30, [sp, -16]!
	.cfi_def_cfa_offset 16
	...
	.cfi_endproc
.LFE11582:
	.size	_GLOBAL__sub_I__Z12calculateNCrxx, .-_GLOBAL__sub_I__Z12calculateNCrxx
	.section	.init_array,"aw",%init_array
	.align	3
	.xword	_GLOBAL__sub_I__Z12calculateNCrxx
