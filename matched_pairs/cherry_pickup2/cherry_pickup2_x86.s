...
.L9:
	...
	.cfi_endproc
.LFE9704:
	.size	_Z7inRangeii, .-_Z7inRangeii
	.globl	_Z12cherryPickupRSt6vectorIS_IiSaIiEESaIS1_EE
	.type	_Z12cherryPickupRSt6vectorIS_IiSaIiEESaIS1_EE, @function
_Z12cherryPickupRSt6vectorIS_IiSaIiEESaIS1_EE:
.LFB9705:
	.cfi_startproc
	endbr64
	push	rbp
	...
	mov	rbx, QWORD PTR -320[rbp]
	mov	rsi, QWORD PTR -312[rbp]
	mov	rdx, rsi
	mov	r14, QWORD PTR -336[rbp]
...
.L38:
	...
	.cfi_endproc
.LFE9705:
	.size	_Z12cherryPickupRSt6vectorIS_IiSaIiEESaIS1_EE, .-_Z12cherryPickupRSt6vectorIS_IiSaIiEESaIS1_EE
	.globl	main
	.type	main, @function
main:
.LFB9706:
	...
	lea	rax, -208[rbp]
	mov	QWORD PTR -304[rbp], rax
	mov	QWORD PTR -296[rbp], 3
	lea	rax, -245[rbp]
	mov	rdi, rax
	call	_ZNSaIiEC1Ev
	lea	rdx, -245[rbp]
	mov	rcx, QWORD PTR -304[rbp]
	mov	rbx, QWORD PTR -296[rbp]
	mov	rsi, rcx
	mov	rdi, rbx
	mov	rdi, rbx
	lea	rax, -160[rbp]
...
.LEHE0:
	...
	mov	DWORD PTR -192[rbp], 5
	mov	DWORD PTR -188[rbp], 1
	lea	rax, -196[rbp]
	mov	QWORD PTR -288[rbp], rax
	mov	QWORD PTR -280[rbp], 3
	lea	rax, -244[rbp]
	mov	rdi, rax
	call	_ZNSaIiEC1Ev
	lea	rax, -244[rbp]
...
.LEHE1:
	...
	mov	DWORD PTR -176[rbp], 5
	lea	rax, -184[rbp]
	mov	QWORD PTR -272[rbp], rax
	mov	QWORD PTR -264[rbp], 3
	lea	rax, -243[rbp]
	mov	rdi, rax
	call	_ZNSaIiEC1Ev
	lea	rax, -243[rbp]
...
.LEHE3:
	...
	mov	rdi, rax
.LEHB4:
	call	_ZNSt6vectorIS_IiSaIiEESaIS1_EEC1ESt16initializer_listIS1_ERKS2_
.LEHE4:
	lea	rax, -241[rbp]
	mov	rdi, rax
...
.L40:
	...
	lea	rax, -240[rbp]
	mov	rdi, rax
	call	_Z12cherryPickupRSt6vectorIS_IiSaIiEESaIS1_EE
	mov	esi, eax
...
.LFB10418:
	...
	lea	rax, -64[rbp]
	mov	rdi, rax
	call	_ZNKSt16initializer_listISt6vectorIiSaIiEEE3endEv
	mov	rbx, rax
	lea	rax, -64[rbp]
	mov	rdi, rax
	call	_ZNKSt16initializer_listISt6vectorIiSaIiEEE5beginEv
	mov	rcx, rax
	mov	rax, QWORD PTR -40[rbp]
	mov	rdx, rbx
	mov	rsi, rcx
	mov	rdi, rax
.LEHB9:
	call	_ZNSt6vectorIS_IiSaIiEESaIS1_EE19_M_range_initializeIPKS1_EEvT_S7_St20forward_iterator_tag
.LEHE9:
	jmp	.L84
.L83:
	endbr64
...
.LLSDACSB10418:
	...
	.uleb128 .LEHE9-.LEHB9
	.uleb128 .L83-.LFB10418
	.uleb128 0
	.uleb128 .LEHB10-.LFB10418
...
.LFB10851:
	...
	mov	rax, QWORD PTR -24[rbp]
	mov	rdi, rax
	call	_ZNKSt16initializer_listISt6vectorIiSaIiEEE4sizeEv
	mov	rdx, rax
	mov	rax, rdx
	add	rax, rax
	add	rax, rdx
...
.LFB10853:
	...
	lea	rax, -8[rbp]
	mov	rdi, rax
	call	_ZSt19__iterator_categoryIPKSt6vectorIiSaIiEEENSt15iterator_traitsIT_E17iterator_categoryERKS6_
	mov	rax, QWORD PTR -8[rbp]
	mov	rdx, QWORD PTR -16[rbp]
	mov	rsi, rdx
	mov	rdi, rax
	call	_ZSt10__distanceIPKSt6vectorIiSaIiEEENSt15iterator_traitsIT_E15difference_typeES6_S6_St26random_access_iterator_tag
	leave
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.LFB10852:
	...
	mov	rsi, rdx
	mov	rdi, rax
	call	_ZSt8distanceIPKSt6vectorIiSaIiEEENSt15iterator_traitsIT_E15difference_typeES6_S6_
	mov	QWORD PTR -24[rbp], rax
	mov	rbx, QWORD PTR -40[rbp]
	mov	rax, QWORD PTR -40[rbp]
	mov	rdi, rax
	...
	mov	rax, QWORD PTR -48[rbp]
	mov	rdi, rax
	call	_ZSt22__uninitialized_copy_aIPKSt6vectorIiSaIiEEPS2_S2_ET0_T_S7_S6_RSaIT1_E
	mov	rdx, QWORD PTR -40[rbp]
	mov	QWORD PTR 8[rdx], rax
	nop
	mov	rbx, QWORD PTR -8[rbp]
...
.LFB11072:
	...
	mov	rsi, rcx
	mov	rdi, rax
	call	_ZSt18uninitialized_copyIPKSt6vectorIiSaIiEEPS2_ET0_T_S7_S6_
	leave
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.LFB11232:
	...
	mov	rsi, rcx
	mov	rdi, rax
	call	_ZNSt20__uninitialized_copyILb0EE13__uninit_copyIPKSt6vectorIiSaIiEEPS4_EET0_T_S9_S8_
	leave
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.LLSDACSB11334:
	...
	.uleb128 .L212-.LFB11334
	.uleb128 0x1
	.uleb128 .LEHB12-.LFB11334
	.uleb128 .LEHE12-.LEHB12
	.uleb128 .L213-.LFB11334
	.uleb128 0
	.uleb128 .LEHB13-.LFB11334
...
.LLSDACSB11445:
	.uleb128 .LEHB14-.LFB11445
	.uleb128 .LEHE14-.LEHB14
	.uleb128 .L226-.LFB11445
	.uleb128 0
	.uleb128 .LEHB15-.LFB11445
...
.LLSDACSB11519:
	...
	.uleb128 .L238-.LFB11519
	.uleb128 0
	.uleb128 .LEHB18-.LFB11519
	.uleb128 .LEHE18-.LEHB18
	.uleb128 .L239-.LFB11519
	.uleb128 0
	.uleb128 .LEHB19-.LFB11519
...
.LLSDACSB11557:
	.uleb128 .LEHB20-.LFB11557
	.uleb128 .LEHE20-.LEHB20
	.uleb128 .L256-.LFB11557
	.uleb128 0
	.uleb128 .LEHB21-.LFB11557
...
.LFE11628:
	...
	.type	_GLOBAL__sub_I__Z7inRangeii, @function
_GLOBAL__sub_I__Z7inRangeii:
.LFB11651:
	.cfi_startproc
	endbr64
	push	rbp
	...
	.cfi_endproc
.LFE11651:
	.size	_GLOBAL__sub_I__Z7inRangeii, .-_GLOBAL__sub_I__Z7inRangeii
	.section	.init_array,"aw"
	.align 8
	.quad	_GLOBAL__sub_I__Z7inRangeii
