	.arch armv8-a
	.file	"G_Powering_the_Hero_hard_version.cpp"
	.text
...
.LEHE0:
	add	x0, sp, 40
	bl	_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEEC1IS2_vEEv
	str	xzr, [sp, 88]
	str	wzr, [sp, 84]
	b	.L10
.L13:
...
.LEHB1:
	...
	bne	.L11
	add	x0, sp, 40
	bl	_ZNKSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE5emptyEv
	and	w0, w0, 255
	eor	w0, w0, 1
	and	w0, w0, 255
	cmp	w0, 0
	beq	.L12
	add	x0, sp, 40
	bl	_ZNKSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE3topEv
	ldr	w0, [x0]
	sxtw	x0, w0
	ldr	x1, [sp, 88]
	add	x0, x1, x0
	str	x0, [sp, 88]
	add	x0, sp, 40
	bl	_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE3popEv
	b	.L12
.L11:
	add	x1, sp, 72
	add	x0, sp, 40
	bl	_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEE4pushERKi
.L12:
	ldr	w0, [sp, 84]
	add	w0, w0, 1
	str	w0, [sp, 84]
...
.LEHE1:
	add	x0, sp, 40
	bl	_ZNSt14priority_queueIiSt6vectorIiSaIiEESt4lessIiEED1Ev
.L9:
	ldr	w0, [sp, 80]
	sub	w1, w0, #1
	str	w1, [sp, 80]
...
.LFB10408:
	...
	mov	x1, x0
	mov	x0, x19
	bl	_ZSt8pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEESt4lessIiEEvT_S9_T0_
	ldr	x0, [sp, 40]
...
.LFB10409:
	...
	mov	x1, x0
	mov	x0, x19
	bl	_ZSt9push_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEESt4lessIiEEvT_S9_T0_
	nop
	ldp	x19, x20, [sp, 16]
	ldp	x29, x30, [sp], 48
	.cfi_restore 30
...
.LFB10818:
	...
	ldr	x1, [sp, 32]
	ldr	x0, [sp, 40]
	bl	_ZSt10__pop_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEENS0_5__ops15_Iter_comp_iterISt4lessIiEEEEvT_SC_SC_RT0_
.L51:
	nop
	ldp	x29, x30, [sp], 64
	.cfi_restore 30
...
.LFB10826:
	...
	strb	w2, [sp, 40]
	add	x0, sp, 40
	bl	_ZSt4moveIRSt4lessIiEEONSt16remove_referenceIT_E4typeEOS4_
	add	x0, sp, 80
	mov	w1, w19
	bl	_ZN9__gnu_cxx5__ops14_Iter_comp_valISt4lessIiEEC1ES3_
	add	x0, sp, 48
	mov	x1, 1
	...
	mov	x1, x19
	ldr	x0, [sp, 56]
	bl	_ZSt11__push_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEliNS0_5__ops14_Iter_comp_valISt4lessIiEEEEvT_T0_SD_T1_RT2_
	nop
	ldr	x19, [sp, 16]
	ldp	x29, x30, [sp], 96
	.cfi_restore 30
...
.LFB11043:
	...
	mov	x1, 0
	ldr	x0, [sp, 56]
	bl	_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEliNS0_5__ops15_Iter_comp_iterISt4lessIiEEEEvT_T0_SD_T1_T2_
	nop
	ldr	x19, [sp, 16]
	ldp	x29, x30, [sp], 80
	.cfi_restore 30
...
.L90:
	...
	mov	x2, x0
	ldr	x0, [sp, 40]
	bl	_ZN9__gnu_cxx5__ops14_Iter_comp_valISt4lessIiEEclINS_17__normal_iteratorIPiSt6vectorIiSaIiEEEEiEEbT_RT0_
	and	w0, w0, 255
	cmp	w0, 0
	beq	.L91
	mov	w0, 1
...
.L105:
	...
	mov	x2, x1
	mov	x1, x19
	bl	_ZN9__gnu_cxx5__ops15_Iter_comp_iterISt4lessIiEEclINS_17__normal_iteratorIPiSt6vectorIiSaIiEEEESB_EEbT_T0_
	and	w0, w0, 255
	cmp	w0, 0
	beq	.L104
	ldr	x0, [sp, 120]
...
.L106:
	add	x0, sp, 32
	bl	_ZSt4moveIRN9__gnu_cxx5__ops15_Iter_comp_iterISt4lessIiEEEEONSt16remove_referenceIT_E4typeEOS8_
	mov	x1, x0
	add	x0, sp, 72
	bl	_ZN9__gnu_cxx5__ops14_Iter_comp_valISt4lessIiEEC1EONS0_15_Iter_comp_iterIS3_EE
	add	x0, sp, 36
	bl	_ZSt4moveIRiEONSt16remove_referenceIT_E4typeEOS2_
	ldr	w0, [x0]
	add	x1, sp, 72
