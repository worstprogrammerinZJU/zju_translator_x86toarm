...
.L6:
	test	rbx, rbx
	jns	.L7
	mov	DWORD PTR -32120[rbp], 0
	lea	rax, -32096[rbp]
	mov	rdi, rax
	call	_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4sizeEv@PLT
	mov	DWORD PTR -32100[rbp], eax
	mov	DWORD PTR -32116[rbp], 0
	mov	DWORD PTR -32112[rbp], 0
	lea	rax, -32121[rbp]
	mov	rdi, rax
...
.LEHE1:
	...
	mov	DWORD PTR -32108[rbp], 0
	jmp	.L8
.L12:
	mov	eax, DWORD PTR -32108[rbp]
	movsx	rdx, eax
	lea	rax, -32096[rbp]
	mov	rsi, rdx
	mov	rdi, rax
.LEHB2:
	...
	test	al, al
	je	.L9
	add	DWORD PTR -32116[rbp], 1
	jmp	.L10
.L9:
	add	DWORD PTR -32112[rbp], 1
.L10:
	mov	eax, DWORD PTR -32108[rbp]
	movsx	rdx, eax
	lea	rax, -32096[rbp]
	...
	mov	eax, DWORD PTR -32116[rbp]
	cmp	eax, DWORD PTR -32112[rbp]
	jne	.L11
	lea	rdx, -32032[rbp]
	mov	eax, DWORD PTR -32120[rbp]
	cdqe
	sal	rax, 5
	add	rdx, rax
	lea	rax, -32064[rbp]
	...
	add	DWORD PTR -32120[rbp], 1
	mov	DWORD PTR -32116[rbp], 0
	mov	DWORD PTR -32112[rbp], 0
.L11:
	add	DWORD PTR -32108[rbp], 1
.L8:
	mov	eax, DWORD PTR -32108[rbp]
	cmp	eax, DWORD PTR -32100[rbp]
	jl	.L12
	mov	eax, DWORD PTR -32120[rbp]
	mov	esi, eax
	...
	mov	DWORD PTR -32104[rbp], 0
	jmp	.L13
.L14:
	lea	rdx, -32032[rbp]
	mov	eax, DWORD PTR -32104[rbp]
	cdqe
	sal	rax, 5
	add	rax, rdx
	mov	rsi, rax
	...
	call	_ZNSolsEPFRSoS_E@PLT
.LEHE2:
	add	DWORD PTR -32104[rbp], 1
.L13:
	mov	eax, DWORD PTR -32104[rbp]
	cmp	eax, DWORD PTR -32120[rbp]
	jl	.L14
	lea	rax, -32064[rbp]
	mov	rdi, rax
...
.LLSDA2082:
	.byte	0xff
	.byte	0x9b
	.uleb128 .LLSDATT2082-.LLSDATTD2082
.LLSDATTD2082:
	.byte	0x1
...
.LLSDACSB2082:
	...
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB8-.LFB2082
	.uleb128 .LEHE8-.LEHB8
	.uleb128 .L56-.LFB2082
	.uleb128 0x1
	.uleb128 .LEHB9-.LFB2082
	.uleb128 .LEHE9-.LEHB9
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB10-.LFB2082
	.uleb128 .LEHE10-.LEHB10
	.uleb128 .L57-.LFB2082
	.uleb128 0
	.uleb128 .LEHB11-.LFB2082
